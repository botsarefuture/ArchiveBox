...
class ArchiveResult:
    ...
    def to_csv(
        self, cols: Optional[List[str]] = None, separator: str = ",", ljust: int = 0
    ) -> str:
        from .csv import to_csv

        return to_csv(
            self, csv_col=cols or self.field_names(), separator=separator, ljust=ljust
        )
...
class Link:
    ...
    def to_csv(
        ...
        return to_csv(
            self, cols=cols or self.field_names(), separator=separator, ljust=ljust
        )
    ...
    def canonical_outputs(self) -> Dict[str, Optional[str]]:
        ...
        canonical = {
            ...
            "google_favicon_path": "https://www.google.com/s2/favicons?domain={}".format(
                self.domain
            ),
